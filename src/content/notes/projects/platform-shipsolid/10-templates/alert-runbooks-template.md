...
- Tempo: look for high-latency or failed traces on [FILL: affected operation name]
...
Every alert configured during
[[projects/platform-shipsolid/10-templates/onboarding-checklist-template|service onboarding]] must
link a runbook in this shape. A condensed, Confluence-native version of this template lives in
