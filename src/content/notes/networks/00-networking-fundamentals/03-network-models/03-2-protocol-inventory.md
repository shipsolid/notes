...
| -------------------------------------------------- | ------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| \*\*OTLP ([[networks/05-http-ecosystem/05-grpc/05-grpc | gRPC]])\*\*                                                                                       | Primary push protocol — binary, HTTP/2 multiplexed, carries all three signal types (metrics, logs, traces) | §1 Protocol, §2 architecture, §3.1 protocol negotiation, §5 OTLP gRPC vs. remote-write |
...
| Protocol                                     | Role                                                                                                                                   | Discussed in                                                                                                        |
| -------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | ------------------------------------------- |
| \*\*[[networks/05-http-ecosystem/05-grpc/05-grpc | gRPC]]\*\*                                                                                                                             | Transport for OTLP; also the channel for the backpressure signal (`RESOURCE_EXHAUSTED` status code)                 | §3.1 fan-in problem, §3.1 backpressure flow |
